...
<div id="page-wrapper">
    ...
    <div id="page">
        ...
        <div id="site-logo-wrapper" class="section-site-logo clearfix">
            ...
            <?php endif; ?>
            <?php if (isset($print_yumpu) && $print_yumpu && isset($yumpu_link) && !empty($yumpu_link)): ?>
                <div id="yumpu-link-wrapper">
                    <a class="yumpu-link" href="<?php print $yumpu_link;?>" target="_blank">
                        <img src="/sites/default/files/pictures/read-number.png"><span class="yumpu-text"><?php print $yumpu_text;?></span>
                    </a>
                </div>
            <?php endif; ?>
        </div>
